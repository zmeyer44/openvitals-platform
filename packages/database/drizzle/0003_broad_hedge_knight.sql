...
ALTER TABLE "app_users" ADD CONSTRAINT "app_users_external_auth_id_auth_users_id_fk" FOREIGN KEY ("external_auth_id") REFERENCES "public"."auth_users"("id") ON DELETE set null ON UPDATE no action;
